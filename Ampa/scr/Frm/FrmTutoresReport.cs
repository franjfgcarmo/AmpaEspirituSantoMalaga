...
namespace Ampa.Frm
{
    public partial class FrmTutoresReport : FrmBase
    {
        ...
        {
           rdbApellidos.Checked = true;
        }

        private void rdbApellidos_CheckedChanged(object sender, System.EventArgs e)
        {
            LoadReport();
        }

        private void rdbNombre_CheckedChanged(object sender, System.EventArgs e)
        {
            LoadReport();
        }
        ...
        private void LoadReport() {
            ...
            query = string.Format(query, Program.ActualCurso.Id, _where, innerJoin, orderBy);
